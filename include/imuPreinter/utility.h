...
public:
    ...
    ParamServer()
    {
        ...
        std::cout<<"odometryFrame : "<<odometryFrame<<std::endl;
    ...
    sensor_msgs::Imu imuConverter(const sensor_msgs::Imu& imu_in)
    {
        ...
        std::cout<<"imu.acc.x:"<<imu_in.linear_acceleration.x<<std::endl;
        std::cout<<"imu.acc.y:"<<imu_in.linear_acceleration.y<<std::endl;
        std::cout<<"imu.acc.z:"<<imu_in.linear_acceleration.z<<std::endl;
        acc = extRot * acc;
        imu_out.linear_acceleration.x = acc.x();
        imu_out.linear_acceleration.y = acc.y();
        imu_out.linear_acceleration.z = acc.z()+imuGravity;
        std::cout<<"trans imu.acc.x:"<<imu_out.linear_acceleration.x<<std::endl;
        std::cout<<"trans imu.acc.y:"<<imu_out.linear_acceleration.y<<std::endl;
        std::cout<<"trans imu.acc.z:"<<imu_out.linear_acceleration.z<<std::endl;
        // rotate gyroscope
        ...
        if (sqrt(q_final.x()*q_final.x() + q_final.y()*q_final.y() + q_final.z()*q_final.z() + q_final.w()*q_final.w()) < 0.1)
        {
            ...
            ROS_WARN("Invalid quaternion, please use a 9-axis IMU!");
            //ros::shutdown();
        }
